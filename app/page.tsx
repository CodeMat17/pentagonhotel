        ...
        <div className="container-page">
          <Reveal y={24} className="max-w-3xl">
            ...
            <h1 className="display mt-5 text-[2.6rem] leading-[1.04] sm:text-6xl lg:text-7xl">
              Pentagon Hotel <span className="text-brand">&amp;</span> Suites
            </h1>

            <p className="mt-6 max-w-xl text-lg leading-relaxed text-pretty text-white/85 sm:text-xl">
              Rooms that stay cool and lit when the street doesn&apos;t. A kitchen
              people drive across town for. Event spaces with their own front
              door. Five minutes from UNIPORT.
            </p>
            ...
            <div className="mt-7 flex flex-wrap items-center gap-x-5 gap-y-3 text-sm font-semibold">
              <span className="flex items-center gap-1.5">
                ...
                {ratingSummary.value} / 5 from {ratingSummary.count} guest reviews
              </span>
          ...
          >
            <div>
              ...
              <p className="mt-2 text-sm leading-relaxed opacity-90">
                We hold back a rate the travel sites never see, and direct guests
                get free parking and first call on room requests.
              </p>
            </div>
            <Button
              size="lg"
              ...
              <article className="group relative flex h-full flex-col overflow-hidden rounded-2xl bg-card ring-1 ring-foreground/10">
                ...
                <div className="flex flex-1 flex-col p-5">
                  ...
                  <p className="mt-4 text-xs font-bold text-brand">
                    Up to {Math.max(...venue.capacities.map((c) => c.seats))} guests
                    · {venue.areaSqm} m²
                  </p>
                </div>
              </article>
      ...
      <Section muted aria-label="Location">
        <div className="grid gap-12 lg:grid-cols-2 lg:items-start">
          <div>
            ...
            <Stagger as="ul" className="mt-8 divide-y rounded-2xl bg-background ring-1 ring-foreground/10">
