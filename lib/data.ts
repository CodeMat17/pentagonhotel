...
export const faqs: FaqItem[] = [
  { category: "Reservations", question: "How do I book a room?", answer: "Book directly on this site for our best available rate — it takes under two minutes and no account is required. You can also call 0803 383 3628, message us on WhatsApp, or email info@pentagoninternationalhotel.com." },
  ...
  { category: "Reservations", question: "Do I need to pay a deposit?", answer: "No. Nothing is paid online at all — you reserve here and settle at the hotel. Your room is held until 20:00 on your arrival date; if you have not arrived or contacted us by then it is released. Group bookings of five rooms or more, and event bookings, require a 50% deposit to confirm." },
  { category: "Reservations", question: "How do I pay?", answer: "At the hotel, by card, bank transfer or cash. There is no online payment on this website and no card details are collected here. Corporate accounts can be invoiced monthly." },
